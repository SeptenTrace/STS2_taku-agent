...
internal static class ObservationApiCatalog
{
    ...
    [
        ...
        new("/api/v1/player/summary", "low", "Player summary with HP, gold, energy, counts, relics, potions, and grouped deck.", "Use when evaluating any choice that depends on build state.", ["*"]),
